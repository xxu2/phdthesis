...
\title{Top-Down Constraining the Emission Estimates of Anthropogenic Aerosols
       and the Emission Parameterization of Mineral Dust}
\author{Xiaoguang Xu}
...
\include{./chapters/ch02} %% Modeling of Atmospheric Dust
\include{./chapters/ch03} %% Adjoint Modeling Developments
\include{./chapters/ch04} %% Optimizing the Dust Emission Estimates
\include{./chapters/ch05} %% Optimizing the Dust Source Parameterization
\include{./chapters/ch06} %% Summary and Outlook 
