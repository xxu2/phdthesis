...
\section{Introduction}
 ...
 \section{General Structure of Inversion} \label{sec:generalstr}
...
\section{Constraints from Satellite Radiances} \label{sec:modisobs}
 ...
 (namely, sulfate (\ce{SO4}), nitrate (\ce{NO3}), amomnium (\ce{NH4}), black carbon (BC), 
 ...
 \begin{figure}[t]
  ...
  \caption{The 0.65 $\mu$m AOD retrieved by \citep{wang10} compared with the MODIS operational collection 5 AOD products. (a) and (b) are their two-month averages for the period of April--May, 2008. The correspondong two-month averages of 0.65-$\mu$m AOD collected at size AERONET sites are color-coded as circles. (c) and (d) are their scatterplot against AOD observed from AERONET sites indicated on the above map. \citep[from][]{wang10}.}
  \label{fig:modisobs}
 \end{figure}
...
\section{Inversion Results} \label{sec:invresult}
 ...
 With the feasibility of the approach demonstrated in section \ref{sec:pseudo}, 
...
We further elucidate those two points below with a literature survey (data are summarized in Table \ref{tab:emssurvey}).
 ...
 \subsection{SO\textsubscript{2}}
  ...
  The INTEX-B inventory by \citet{zhang09b} reported an annual production of 31.02 Tg from anthropogenic sources over China. 
...
With OMI \ce{SO2} retrievals, \citet{lu10} found the dramatic reduction of \ce{SO2} emissions over the northern China for the same period. 
...
Evidences for the reduction trend of \ce{SO2} emission also include the reduction of \ce{SO2} column from 2006 observed by both SCIAMACHY and OMI satellite sensors \citep{lu11}.
With the same SCIAMACHY and OMI \ce{SO2} retrievals, \citet{lee11} obtained top-down estimates of China SO2 emissions, 
...
Thus, the reduction of 33.5\% in the top-down China \ce{SO2} emissions of this work can be interpreted by the joint contribution of a decrease trend and a possible overestimation in INTEX-B bottom-up inventory.
 ...
 \subsection{NH\textsubscript{3} } 
  ...
  The \ce{NH3} emissions over China have not changed much since 2000, as confirmed by the REAS inventory \citep{ohara07}.
...
As shown in Table \ref{tab:emssurvey}, the total amount of the constrained \ce{NH3} emission (0.72 Tg Mon$^{-1}$) for April 2008 is quite close to a recent bottom-up estimates (0.71 Tg Mon$^{-1}$) by \citet{Huang12}. 
\citet{Huang12} also pointed out that the TRACE-P 2000 inventory significantly overestimates the \ce{NH3} emission by applying an overestimated emission factor across the whole country. 
...
\end{table}
 ...
 \subsection{NOx} 
  ...
  \citet{lin10} constrained Chinese anthropogenic emissions of \ce{NOx} in July 2008 with tropospheric \ce{NO2} retrievals from GOME-2 and OMI instruments.
...
While the change in \ce{NOx} emission over China remains controversy, the 18.8\% difference of posterior NOx emissions from the bottom-up still lies in the 31\% uncertainty of the inventory \citep{zhang09b}.
